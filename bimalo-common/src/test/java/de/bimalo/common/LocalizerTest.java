...
public class LocalizerTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        instance.addResourceBundle("de.bimalo.common.resources.LocalizerTestBundle1", getClass());
        instance.addResourceBundle("de.bimalo.common.resources.LocalizerTestBundle2", getClass());
    }
    ...
    /**
     * <p> Test the feature of managing a ResourceBundle with class
     * <code>Localizer</code>. It shows how to add initialize a Localizer, how
     * to add a ResourceBundle and get values back from added ResourceBundles
     * with the Localizer.</p> <p> It does not consider any exception
     * testing!</p>
     */
    public void testResourceBundleManagement() {
        ...
        ResourceBundle bundle1 = instance.getResourceBundle("de.bimalo.common.resources.LocalizerTestBundle1");
        ...
        bundle1 = instance.getResourceBundle("de.bimalo.common.resources.LocalizerTestBundle1");
        assertNotNull(bundle1);
    ...
    /**
     * Test getResourceBundle by providing a name for the ResourceBundle that
     * does not exist in Localizer.
     */
    ...
    /**
     * Test getResourceString with a key that does not exist in the
     * ResourceBundle. In this case the key itself will be return as result.
     */
    ...
    /**
     * Test different settings for the parameter array when using function
     * getResourceString.
     */
    public void testGetResourceString_String_ObjectArr2() {
        ...
        assertEquals("Test mit DoesNotExistInBundle1, DoesNotExistInBundle2 Werten.", instance.getResourceString("s4", param1));

        Object[] param2 = new Object[2];
        param2[0] = "s1";
        param2[1] = "DoesNotExistInBundle2";
        assertEquals("Test mit Wert1, DoesNotExistInBundle2 Werten.", instance.getResourceString("s4", param2));

        Object[] param3 = new Object[2];
        param3[0] = "DoesNotExistInBundle1";
        param3[1] = "s2";
        assertEquals("Test mit DoesNotExistInBundle1, Wert2 Werten.", instance.getResourceString("s4", param3));
    }
    ...
    public void testFormatDateObject_Date_String() {
        /*
        System.out.println("formatDateObject");
        Date date2convert = DateFactory.getInstance(instance).createDate(2, 2, 2012);
        String result = instance.formatDateObject(date2convert, "yy.MM.yyyy");
        assertEquals("02.02.2012", result);
        */
    }
    ...
    public void testFormatNumberObject() {
        /*
        System.out.println("formatNumberObject");
        Double number = Double.valueOf("47,1134");
        String result = instance.formatNumberObject(number, 3, 2);
        assertEquals("47,11", result);
        */
    }
    ...
    public void testParseDateString_String() throws Exception {
        ...
        Date result = instance.parseDateString("02.02.2012");
    ...
    public void testRemoveResourceBundle() {
        ...
        instance.removeResourceBundle("de.bimalo.common.resources.LocalizerTestBundle2");
        assertNull(instance.getResourceBundle("de.bimalo.common.resources.LocalizerTestBundle2"));
    }
}
