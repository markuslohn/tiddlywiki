...
/**
 * <p> A factory to create objects of type <code>java.util.Date</code>.</p>
 * <p> It is implemented as singleton!</p>
 *
...
public final class DateFactory {
    ...
    /**
     * Constructs a new
     * <code>DateFactory<code> object. When local is null
    ...
    /**
     * Returns a
     * <code>DateFactory</code> using the default Locale.
     *
     * @return the initialized DateFactory.
     */
    public synchronized static DateFactory getInstance() {
        if (factory == null) {
    ...
    /**
     * Returns a
     * <code>DateFactory</code> using the given Locale.
     *
     ...
     * and locale is null
     */
    public synchronized static DateFactory getInstance(Locale locale) {
        if (factory == null) {
    ...
    /**
     * Returns a
     * <code>DateFactory</code> using the given Localizer.
     *
     ...
     */
    public synchronized static DateFactory getInstance(Localizer localizer) {
        if (factory == null) {
            Assert.notNull(localizer);
            factory =
                    new DateFactory(( localizer != null ? localizer.getLocale()
                    : null ));
        }
        return factory;
    }
    ...
    /**
     * <p> Creates a
     * <code>Date</code> object only with the day, month and year. It does not
     * include time settings!</p> <p> Example:<br>
     * <code>
     *   Date date = DateFactory.getInstance().createDate(24,1,2004);
     * </code> Result = 24.1.2004 </p>
     *
    ...
    /**
     * <p> Creates a
     * <code>Date</code> object including time information.</p> <p> Example:<br>
     * <code>
     *   Date date = DateFactory.getInstance().createDate(24,1,2004,15,24,30);
     * </code> Result = 24.1.2004 15:24:30 </p>
     *
     * @param day number between 1 and 31
     * @param month number between 1 and 12
     * @param year a 4 digit number, e.g. 1999
    ...
    private void validateDateValues(int day, int month, int year) {
        ...
        Assert.isTrue(Integer.valueOf(year).toString().length() == 4, "Year is not a 4 digit number.");
    }
