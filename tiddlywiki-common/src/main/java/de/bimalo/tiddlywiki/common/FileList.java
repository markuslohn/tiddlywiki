...
/**
 * <p>
 * FileList allows to traverse a folder hierarchy beginning with a specified folder and selects only
 * the files matching the specified regular expression.
 * </p>
 * <p>
 * After creation of the FileList the root folder cannot be modified. However when calling listFiles
 * the processing starts again! The result is not cached internally!
 * </p>
 *
...
public final class FileList {
   ...
   * @throws FileNotFoundException if root points to a directory that does not exists
   * @throws PatternSyntaxException if the regexp's syntax is invalid
   */
  public FileList(String root, String regexp) throws FileNotFoundException, PatternSyntaxException {
    Assert.notNull(root);
  ...
  /**
   * Gets a list of <code>File</code> objects available in the provided directory.
   *
  ...
  /**
   * <p>
   * Loops through the folder hierarchy based on directory and include all files in the result list
   * matching the defined pattern.
   * </p>
   *
