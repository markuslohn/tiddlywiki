 ...
 *
 * <p>
 * For more Assert functions take a look at <code>in org.apache.commons.lang.Validate</code> and/or
...
public final class Assert {
   ...
   * </p>
   * <p>
   * This is used when validating according to an arbitrary boolean expression, such as validating a
   ...
   * </pre>
   *
   * @param object the object to check is not <code>null</code> if the object is <code>null</code>
   * @throws IllegalArgumentException if the object is <code>null</code>
   */
   ...
   * is empty (<code>null</code> or no elements).
   * </p>
   * 
   * <pre>
  ...
  /**
   * <p>
   * Validate an argument, throwing <code>IllegalArgumentException</code> if the argument type is an
   * instance of object.
   * </p>
   * .
   *
   ...
   * @param clazz the class object to check is instance of
   * @param obj the base object type
   * @param message the exception message you would like to see if the validation fails
   */
