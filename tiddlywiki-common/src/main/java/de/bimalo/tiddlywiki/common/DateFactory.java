...
public final class DateFactory {
  ...
  /**
   * The Locale used to create Date objects considering language specific formats.
   */
  private Locale locale = null;

  /**
   * Constructs a new <code>DateFactory</code> object. When local is null the default Locale will be
   * used instead.
   *
   ...
   * @return the initialized DateFactory.
   * @exception IllegalArgumentException if DateFactory not yet initialized and locale is null
   */
   ...
   * @return the initialized DateFactory.
   * @exception IllegalArgumentException if DateFactory not yet initialized and localizer is null
   */
  ...
  /**
   * <p>
   * Creates a <code>Date</code> object only with the day, month and year. It does not include time
   * settings!
   * </p>
   * Example:<br>
   * <code>
