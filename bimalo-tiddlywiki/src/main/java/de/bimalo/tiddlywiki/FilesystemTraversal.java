 ...
 * Tiddler's for every found file and folder.</p>
 *
...
public final class FilesystemTraversal {
     ...
     * TagCloud pluginis required so that this Tiddler will function correctly.
     */
     ...
     */
    public FilesystemTraversal(FileObject rootFolder) throws IOException {
     ...
     */
    private void traverse(FileObject parentFolder, Tiddler parentTiddler, int level) throws IOException {
     ...
     */
    private Tiddler createTiddler(FileObject file) throws IOException {
        FileObjectVisitor visitor = null;

        //TODO: Use a factory to obtain the Visitor implementations.
        if (file.getType().equals(FileType.FILE)) {
            visitor = new DocumentVisitor();
        } else {
            visitor = new DirectoryVisitor();
        }
    ...
    private TiddlyWiki createTiddlyWiki(Tiddler rootTiddler) {
        TiddlyWiki wiki = createTiddlyWiki(rootTiddler.getTitle(), localizer.formatDateObject(new Date(), "dd.MM.yyyy hh:mm:ss"));
    ...
    private boolean isSupportedFileObject(FileObject file) throws FileSystemException {
        ...
        if (file.getType().equals(FileType.FOLDER)) {
            ...
            //TODO: Make the list of formats configurable
             ...
             * included in the TiddlyWiki. Due to this filter this file
             * afterwards.
             */
