...
public final class Localizer {
    ...
    /**
     * Constructs a new <code>Localizer</code> with the given Locale. If locale
     * is null the default Locale will be used instead.
     *
     ...
     * </p>
     * If local is null this function does nothing. Otherweise all registered
     * ResourceBundles will be reloaded with the new Locale. Furthermore if
    ...
    /**
     * Lookup a <code>ResourceBundle</code> with a given name in the registry of
     * this Localizer. The name should be identical to that one used to add the
     * ResourceBundle, like <code>org.test.resources.ExtendedResources</code>. A
     * context sensitiv search will be performed.
     *
    ...
    /**
     * Adds a <code>ResourceBundle</code> with the given name to this Localizer
     * object. It tries to use the class loader from the given class object
     ...
     * by <code>java.text.DateFormat.MEDIUM</code>.
     *
     * @param date the date to convert
     * @return the formatted Date object as string.
     ...
     * pre-defined formatsin <code>java.text.DateFormat.</code>. The formats
     * SHORT, MEDIUM, LONG, FULL are used!. If the String could not be converted
     * into a Date object an exception raised!
     *
     * @param dateString a String contains date and time information
    ...
    /**
     * Loads the <code>ResourceBundle</code> with the given name from the class
     * path. If it can not locate the bundle with the current class loader or
     * with the class loader from the second parameter <code>theRefererer</code>
     * it uses the context class loader.
     *
